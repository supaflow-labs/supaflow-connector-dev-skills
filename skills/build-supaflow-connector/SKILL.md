...
description: Build or review Java and Python/dlt Supaflow connectors using a phased workflow for source connectors, warehouse destinations, and activation targets. Use this skill when implementing a new connector, debugging connector reads or field selection, adding incremental sync, or validating connector quality in a Supaflow platform repository with executable gates and anti-pattern enforcement.
---
...
- Verification script passes all applicable checks (Java checks `1-15`, Python/dlt field-projection gates, plus destination checks `16-24`).
